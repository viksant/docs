---
title: "Calendly"
description: "What the Calendly integration can and can't do, and how to connect it step by step."
icon: "calendar"
---
...
<Steps>
  ...
  <Step title="Connect and authorize" icon="link">
    Click **Connect**. A secure popup opens — sign in to Calendly and authorize access. You never type credentials into BestChatBot. If Cal.com is currently active, you'll be asked to confirm replacing it.
  </Step>
  <Step title="Choose an event type" icon="calendar-check">
    Calendly needs one more step: pick the **event type** the bot will book (for example, "Intro call"). Until you select one, the integration shows a **needs setup** badge and won't book meetings.
  </Step>
</Steps>

Once set up, Calendly's actions become available to your widget right away.
