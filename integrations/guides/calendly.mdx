...
<Steps>
  ...
  <Step title="Connect and authorize" icon="link">
    ...
    <Frame>
      <img src="/integrations/calendly-integration/connect-authorize.png" alt="Calendly OAuth authorization screen granting BestChatBot scheduling access" />
    </Frame>
  </Step>
  <Step title="Choose an event type" icon="calendar-check">
    ...
    <Frame>
      <img src="/integrations/calendly-integration/event-type.png" alt="Selecting a Calendly event type from the dropdown in the integration panel" />
    </Frame>
  </Step>
</Steps>
...
<Frame>
  <img src="/integrations/calendly-integration/connected.png" alt="Connected Calendly panel showing the selected event type and capability toggles" />
</Frame>
