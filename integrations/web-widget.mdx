...
<Steps>
  <Step title="Open Widget Setup" icon="window-maximize">
    From your workspace, open the **Web Widget** setup. You'll land on a form where you set the widget's metadata and brand styling.
  </Step>
  ...
  <Step title="View Your Widget" icon="check">
    ...
    - **Active toggle** to turn the widget on or off
...
<Tip>Each conversation is anchored to a visitor session in their browser, so you can see the full back-and-forth, not just isolated questions.</Tip>
