...
<Steps>
  ...
  <Step title="Configure URL Filters (Optional)">
    When using **Crawl** or **Sitemap**, you can set URL pattern filters to include or exclude specific pages. This lets you focus the scraper on the content that matters.
  </Step>
