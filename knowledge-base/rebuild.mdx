...
1. **Reads** all your documents, scraped pages, and Q&A entries
...
<Tip>You can continue using the dashboard while a rebuild is in progress. The bot will keep using the previous knowledge base until the new one is ready.</Tip>
