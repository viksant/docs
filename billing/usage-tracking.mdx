...
The widget responds to **every** visitor message. There is no question detector and no skip logic. Each reply counts as **one bot response**. The following do **not** count:

| Action | Counts as Response? |
|--------|---------------------|
| Widget replies to a visitor message | Yes |
