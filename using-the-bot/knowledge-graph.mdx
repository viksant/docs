...
The knowledge graph helps you understand:

| Insight | How It Helps |
|---------|--------------|
| **Coverage gaps** | Isolated nodes with few connections may need more supporting content |
| **Content clusters** | See which topics have the most depth in your knowledge base |
| **Unexpected connections** | Find relationships between topics you hadn't considered |
| **Content balance** | Spot areas that are over- or under-represented |

<Tip>A well-connected knowledge graph means the bot can answer questions more thoroughly by drawing from multiple related sources.</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Manage Channels" icon="list" href="/customization/channel-management">
    Control where the bot is active.
  </Card>
</CardGroup>
