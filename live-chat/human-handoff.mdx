...
When the visitor taps it, the widget asks them to confirm first — *"Talk to our support team? Your conversation will be shared with our support agents, who may use third-party services to reply."* — with **Cancel** and **Confirm**. Only after they confirm does the request reach your team.

<Frame>
  <img src="/images/handoff-consent-overlay.png" alt="Widget consent overlay shown before starting a human handoff" />
</Frame>

The conversation joins your team's queue, and your operators get an email letting them know a visitor is waiting.
