...
In the **Live inbox**, waiting conversations appear in real time — a sound plays when a new one arrives (you can mute it). Each conversation shows a status: **Waiting**, **Active**, **Closed**, or **Slack**. A **Waiting** conversation is an async ticket — a visitor who wrote outside your [office hours](/live-chat/office-hours), or one no operator claimed in time. The bot keeps answering and you can reply whenever; the visitor is emailed when you do.
