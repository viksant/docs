...
<Steps>
  <Step title="Elige Plataforma" icon="window-maximize">
    Desde tu workspace, veras el dialogo **Elegir Plataforma**. Selecciona **Web Widget** para integrar chat en tu sitio web.

    <Frame>
      <img src="/images/widget-choose-platform.png" alt="Dialogo Elegir Plataforma mostrando opciones de Discord y Web Widget" />
    </Frame>
  </Step>
...
<Tip>Las conversaciones del widget muestran un badge **Web**, lo que las hace faciles de distinguir de las conversaciones de Discord.</Tip>
