...
<Steps>
  ...
  <Step title="Test and Go Live" icon="circle-check">
    Open your website — a chat bubble appears in the bottom-right corner. Click it and try a question. You can also use the **Retrieval Testing** page in your dashboard to dry-run the bot before opening it to visitors.
